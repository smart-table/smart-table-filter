...
const operators = {
    ...
    ["is" /* IS */]: is,
    ["isNot" /* IS_NOT */]: smartTableOperators.compose(is, not),
    ["lt" /* LOWER_THAN */]: lt,
    ["gte" /* GREATER_THAN_OR_EQUAL */]: smartTableOperators.compose(lt, not),
    ["gt" /* GREATER_THAN */]: gt,
    ["lte" /* LOWER_THAN_OR_EQUAL */]: smartTableOperators.compose(gt, not),
    ["equals" /* EQUALS */]: equals,
    ["notEquals" /* NOT_EQUALS */]: smartTableOperators.compose(equals, not),
    ["anyOf" /* ANY_OF */]: anyOf
};
